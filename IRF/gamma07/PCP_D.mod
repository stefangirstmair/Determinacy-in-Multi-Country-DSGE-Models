...
theta_p     = 0.70;                 % price stickiness 0.75
theta_W     = 0.59;                  % Wage rigidity 0.85
...
p_G_GR_reset = beta*theta_p*(p_G_GR_reset(+1)+pi_G(+1)) + (1-beta*theta_p)/(1+Gamma)*(mc_G - Gamma*(q_R - q_G) + mu_bar); %%% new
...
p_R_RG_reset = beta*theta_p*(p_R_RG_reset(+1)+pi_R(+1)) + (1-beta*theta_p)/(1+Gamma)*(mc_R - Gamma*(q_G - q_R) + mu_bar); %%% new
