...
stoch_simul(order=1, periods=1000, drop=100, irf=20,nograph);
...
% ESTIMATION RESULTS
% 
% Log data density is 2224.213044.
% 
% parameters
%              prior mean   post. mean        90% HPD interval    prior       pstdev
% 
% phi_pi_U          1.500       1.4826      1.1585      1.8081     gamm       0.2500
% phi_pi_G          1.500       1.5695      1.2281      1.9123     gamm       0.2500
% phi_pi_R          1.500       1.5376      1.1116      1.9556     gamm       0.2500
% phi_Y_U           0.250       0.7731      0.6280      0.9201     norm       0.1500
% phi_Y_G           0.250       0.7998      0.6651      0.9369     norm       0.1500
% phi_Y_R           0.250       0.3322      0.1195      0.5485     norm       0.1500
% theta_p           0.750       0.7389      0.7184      0.7603     beta       0.1000
% theta_W           0.750       0.6026      0.4208      0.7736     beta       0.1000
% rho_m_U           0.750       0.5162      0.4333      0.6017     beta       0.1000
% rho_m_G           0.750       0.5388      0.4563      0.6238     beta       0.1000
% rho_m             0.750       0.7261      0.5984      0.8530     beta       0.1000
% rho_eps_U         0.750       0.9277      0.9110      0.9435     beta       0.1000
% rho_eps_G         0.750       0.9135      0.8931      0.9322     beta       0.1000
% rho_eps_R         0.750       0.7319      0.5991      0.8730     beta       0.1000
% rho_uip_G         0.750       0.9619      0.9519      0.9724     beta       0.1000
% rho_uip_R         0.750       0.8219      0.7417      0.9046     beta       0.1000
% 
...
% eps_i_R           0.010       0.0077      0.0048      0.0103     invg       0.0050
% eps_R             0.010       0.0091      0.0044      0.0137     invg       0.0050
% eps_G             0.010       0.0259      0.0215      0.0299     invg       0.0050
% eps_a_U           0.010       0.0053      0.0042      0.0064     invg       0.0050
% eps_a_G           0.010       0.0052      0.0043      0.0062     invg       0.0050
% eps_a_R           0.010       0.0094      0.0043      0.0150     invg       0.0050
% eps_uip_G         0.010       0.0033      0.0027      0.0040     invg       0.0050
% eps_uip_R         0.010       0.0087      0.0053      0.0120     invg       0.0050
% Total computing time : 0h44m27s
