...
T(24) = exp(y(156)-y(51)*params(32))^(-params(5));
T(25) = params(1)*(1+y(57))*T(24);
T(26) = exp(y(158)-y(53)*params(32))^(-params(5));
T(27) = params(1)*(1+y(59))*T(26);
T(28) = exp(y(157)-y(52)*params(32))^(-params(5));
T(29) = params(1)*(1+y(58))*T(28);
T(30) = (1-params(1)*params(15))*(1-params(15))/(params(15)*(1+params(6)*params(12)));
T(31) = params(5)/(1-params(32));
T(32) = exp(y(77))*(1-params(2))/exp(y(68));
T(33) = exp(y(79))*(1-params(2))/exp(y(69));
T(34) = exp(y(78))*(1-params(2))/exp(y(70));
T(35) = exp(y(77))*params(2)/exp(y(74));
T(36) = exp(y(79))*params(2)/exp(y(75));
T(37) = exp(y(78))*params(2)/exp(y(76));
