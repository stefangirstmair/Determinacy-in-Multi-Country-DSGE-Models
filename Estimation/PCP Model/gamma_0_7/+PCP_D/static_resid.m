...
residual(7) = lhs - rhs;
lhs = y(68);
rhs = params(1)*params(60)*(y(68)+y(16))+T(8)*(y(33)-y(54)*params(22)+params(23));
residual(8) = lhs - rhs;
lhs = y(69);
rhs = params(1)*params(60)*(y(69)+y(18))+T(8)*(params(23)+y(54)+y(33));
residual(9) = lhs - rhs;
lhs = y(16);
rhs = (1-params(60))*(y(16)+y(68)-y(66));
residual(10) = lhs - rhs;
lhs = y(18);
rhs = (1-params(60))*(y(18)+y(69)-y(67));
residual(11) = lhs - rhs;
lhs = exp(y(44));
...
residual(14) = lhs - rhs;
lhs = y(74);
rhs = params(1)*params(60)*(y(16)+y(74))+T(8)*(params(23)+y(33)-params(22)*y(55));
residual(15) = lhs - rhs;
lhs = y(75);
rhs = params(1)*params(60)*(y(75)+y(17))+T(8)*(params(23)+y(33)+y(55));
residual(16) = lhs - rhs;
lhs = y(16);
rhs = (1-params(60))*(y(16)+y(74)-y(72));
residual(17) = lhs - rhs;
lhs = y(17);
rhs = (1-params(60))*(y(17)+y(75)-y(73));
residual(18) = lhs - rhs;
lhs = exp(y(45));
rhs = T(6)*T(12);
residual(19) = lhs - rhs;
...
residual(22) = lhs - rhs;
lhs = y(80);
rhs = params(1)*params(63)*(y(16)+y(80))+T(15)*(params(23)+y(34)-y(54));
residual(23) = lhs - rhs;
lhs = y(81);
rhs = params(1)*params(63)*(y(18)+y(81))+T(15)*(params(23)+y(54)*params(22)+y(34));
residual(24) = lhs - rhs;
lhs = y(16);
rhs = (1-params(63))*(y(16)+y(80)-y(78));
residual(25) = lhs - rhs;
lhs = y(18);
rhs = (1-params(63))*(y(18)+y(81)-y(79));
residual(26) = lhs - rhs;
lhs = exp(y(47));
...
residual(30) = lhs - rhs;
lhs = y(88);
rhs = params(1)*params(63)*(y(17)+y(88))+T(15)*(params(23)+y(55)+y(34)-y(54));
residual(31) = lhs - rhs;
lhs = y(89);
rhs = params(1)*params(63)*(y(18)+y(89))+T(15)*(params(23)+y(34)-params(22)*y(55));
residual(32) = lhs - rhs;
lhs = y(90);
rhs = params(1)*params(63)*(y(16)+y(90))+T(15)*(params(23)+y(34)-y(54)-params(22)*y(55));
residual(33) = lhs - rhs;
lhs = y(17);
rhs = (1-params(63))*(y(17)+y(88)-y(85));
residual(34) = lhs - rhs;
lhs = y(18);
rhs = (1-params(63))*(y(18)+y(89)-y(86));
residual(35) = lhs - rhs;
lhs = y(16);
rhs = (1-params(63))*(y(16)+y(90)-y(87));
residual(36) = lhs - rhs;
lhs = exp(y(48));
rhs = T(10)*T(19);
residual(37) = lhs - rhs;
...
residual(40) = lhs - rhs;
lhs = y(95);
rhs = params(1)*params(66)*(y(16)+y(95))+T(22)*(params(23)+y(35)-y(55));
residual(41) = lhs - rhs;
lhs = y(96);
rhs = params(1)*params(66)*(y(17)+y(96))+T(22)*(params(23)+params(22)*y(55)+y(35));
residual(42) = lhs - rhs;
lhs = y(16);
rhs = (1-params(66))*(y(16)+y(95)-y(93));
residual(43) = lhs - rhs;
lhs = y(17);
rhs = (1-params(66))*(y(17)+y(96)-y(94));
residual(44) = lhs - rhs;
lhs = exp(y(50));
...
residual(48) = lhs - rhs;
lhs = y(103);
rhs = params(1)*params(66)*(y(17)+y(103))+T(22)*(params(23)+y(35)-y(54)*params(22));
residual(49) = lhs - rhs;
lhs = y(104);
rhs = params(1)*params(66)*(y(18)+y(104))+T(22)*(params(23)+y(54)+y(35)-y(55));
residual(50) = lhs - rhs;
lhs = y(105);
rhs = params(1)*params(66)*(y(16)+y(105))+T(22)*(params(23)+y(35)-y(55)-y(54)*params(22));
residual(51) = lhs - rhs;
lhs = y(17);
rhs = (1-params(66))*(y(17)+y(103)-y(100));
residual(52) = lhs - rhs;
lhs = y(18);
rhs = (1-params(66))*(y(18)+y(104)-y(101));
residual(53) = lhs - rhs;
lhs = y(16);
rhs = (1-params(66))*(y(16)+y(105)-y(102));
residual(54) = lhs - rhs;
...
lhs = y(10);
rhs = params(1)*params(60)*(y(16)+y(10))+T(8)*(y(33)+params(23));
residual(58) = lhs - rhs;
lhs = y(11);
rhs = params(1)*params(63)*(y(18)+y(11))+T(15)*(params(23)+y(34));
residual(59) = lhs - rhs;
lhs = y(12);
rhs = params(1)*params(66)*(y(17)+y(12))+T(22)*(params(23)+y(35));
residual(60) = lhs - rhs;
lhs = y(16);
rhs = (1-params(60))*(y(16)+y(10)-y(1));
residual(61) = lhs - rhs;
lhs = y(18);
rhs = (1-params(63))*(y(18)+y(11)-y(2));
residual(62) = lhs - rhs;
lhs = y(17);
rhs = (1-params(66))*(y(17)+y(12)-y(3));
residual(63) = lhs - rhs;
lhs = y(5);
...
residual(69) = lhs - rhs;
lhs = y(51);
rhs = exp(y(42)+y(1))+params(35)*exp(y(70)+y(72))+params(36)*exp(y(71)+y(55)+y(73))+params(33)*exp(y(64)+y(66))+params(34)*exp(y(65)+y(54)+y(67))-exp(y(39)+y(33));
residual(70) = lhs - rhs;
lhs = y(52);
...
lhs = y(56);
rhs = y(56)*params(55)+x(1);
residual(98) = lhs - rhs;
lhs = y(57);
rhs = y(57)*params(56)+x(2);
residual(99) = lhs - rhs;
lhs = y(58);
rhs = y(58)*params(18)+x(3);
residual(100) = lhs - rhs;
lhs = y(62);
rhs = y(62)*params(57)+x(9);
residual(101) = lhs - rhs;
lhs = y(63);
rhs = y(63)*params(28)+x(10);
residual(102) = lhs - rhs;
lhs = y(59)-params(25);
rhs = (y(59)-params(25))*params(58)+x(6);
residual(103) = lhs - rhs;
lhs = y(60)-params(25);
rhs = (y(60)-params(25))*params(59)+x(7);
residual(104) = lhs - rhs;
lhs = y(61)-params(25);
rhs = (y(61)-params(25))*params(26)+x(8);
