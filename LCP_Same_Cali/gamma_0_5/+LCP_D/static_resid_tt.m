...
T(29) = (1-params(1)*params(62))*(1-params(62))/(params(62)*(1+params(6)*params(12)));
T(30) = (1-params(1)*params(65))*(1-params(65))/((1+params(6)*params(12))*params(65));
T(31) = (1-params(1)*params(68))*(1-params(68))/((1+params(6)*params(12))*params(68));
